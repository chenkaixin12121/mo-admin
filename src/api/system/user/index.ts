...
export function getUserInfo(): AxiosPromise<UserInfo> {
  return request({
    url: '/mo-admin/api/v1/users/info',
    method: 'get',
  });
}
...
export function listUserPages(
  ...
  return request({
    url: '/mo-admin/api/v1/users/pages',
    method: 'post',
    data: queryParams,
  });
}
...
export function getUserForm(userId: number): AxiosPromise<UserForm> {
  return request({
    url: '/mo-admin/api/v1/users/' + userId,
    method: 'get',
  });
}
...
export function downloadTemplate() {
  return request({
    url: '/mo-admin/api/v1/users/template',
    method: 'get',
...
export function exportUser(queryParams: UserQuery) {
  return request({
    url: '/mo-admin/api/v1/users/_export',
    method: 'get',
    params: queryParams,
    responseType: 'arraybuffer',
  });
...
export function importUser(deptId: number, roleIds: string, file: File) {
  ...
  return request({
    url: '/mo-admin/api/v1/users/_import',
    method: 'post',
    data: formData,
    headers: {
